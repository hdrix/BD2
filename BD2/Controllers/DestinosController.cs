...
namespace BD2.Controllers
{
    public class DestinosController : Controller
    {
        ...
        public DestinosController(ProjectContext context)
        {
            _context = context;    
        }
        ...
        public async Task<IActionResult> Create([Bind("ID,Nombre,Salida")] Destino destino)
        {
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var destino = await _context.Destino.SingleOrDefaultAsync(m => m.ID == id);
            if (destino == null)
            {
                return NotFound();
            }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Nombre,Salida")] Destino destino)
        {
            if (id != destino.ID)
            {
                return NotFound();
